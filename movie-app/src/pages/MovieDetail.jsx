...
const MovieDetail = () => {
  ...
  useEffect(() => {
    //! Promise.all ile api istekleri senkron siraya sokulabilir.
  ...
  return (
    <div className="md:container px-10 mx-auto py-5">
      <h1 className="text-center text-black dark:text-white text-3xl">
        {title}
      </h1>
      {videoKey && <VideoSection videoKey={videoKey} />}

      <div className="md:container flex justify-center px-10">
        <div className="flex flex-col lg:flex-row max-w-6xl rounded-lg bg-gray-300 dark:bg-gray-100 shadow-lg">
          <img
