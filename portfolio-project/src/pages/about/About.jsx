    ...
    <>
      ...
      <div className="about-me container d-flex flex-column justify-content-center align-items-center">
        ...
        <p className="about-me_description">
          CoolDev is lorem ipsum dolor sit amet consectetur, adipisicing elit.
      ...
      <div class="about-me-history container-fluid d-flex flex-column justify-content-start align-items-center gap-3">
        <div class="about-me-history_job">
          <h2 class="text-dark">2020 - 2021</h2>
          <h3>Cool Dev LLC</h3>
        ...
        <div class="about-me-history_job">
          <h2 class="text-dark">2019 - 2020</h2>
          <h3>Google</h3>
        ...
        <div class="about-me-history_job">
          <h2 class="text-dark">2017 - 2019</h2>
