...
const About = () => {
  return (
    <AboutContainer marginbottom="10rem">
      <ProfileImg src={profileImg} alt="brand logo" />
      <InfoContainer>
        <h2>Hi, it's CoolDev.</h2>
        <h3>I'm currently learning Full-Stack Development.</h3>
        <h4>I've already known JS, ReactJS, SQL, Python.</h4>
      ...
      <IconContainer>
        ...
        {iconData.map((item) => (
          <Link key={item.icon} to={item.href} target="_blank">
